...
public class VehicleDaoImpl__MapperGenerated extends DaoBase implements VehicleDao {
  ...
  private VehicleDaoImpl__MapperGenerated(MapperContext context,
      ...
      BicycleHelper__MapperGenerated bicycleHelper, PreparedStatement deleteByIdStatement,
      VehicleQueryProvider findByIdInvoker, VehicleQueryProvider saveInvoker) {
    super(context);
  ...
  public static CompletableFuture<VehicleDao> initAsync(MapperContext context) {
    ...
    try {
      ...
      SimpleStatement deleteByIdStatement_simple = carHelper.deleteByPrimaryKeyParts(1).build();
